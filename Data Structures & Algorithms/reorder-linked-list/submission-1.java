...
class Solution {
    public void reorderList(ListNode head) {
        ...
        //By now prev would hold the address of the last node

        //Regardless of size , the node after the middle node will always point to null as it is the first node in the seperated list AND slow.next = null 
        while(second != null){
